...
//        Game.Player playerO = game.new Player(listener.accept(), 'O');
        ...
        OldPlayer player1 = OldServer.acceptPlayer(server, 1);
...
//        player2.setOpponent(player1);
	...
	private static OldPlayer acceptPlayer(ServerSocket listener, int playerId) throws IOException
	{
		System.out.println("SERVER: Waiting for client...");
		OldPlayer player = new OldPlayer(listener.accept(), playerId);
